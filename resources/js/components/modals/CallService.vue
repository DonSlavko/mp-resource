                        ...
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        Mit dem drücken des Senden Buttons haben Sie auch die <a href="/datenschutzerklaerung">Datenschutzerklärung</a> zur Kenntnis genommen.
                                    </v-col>
    ...
    methods: {
        ...
        submit() {
            ...
            if (this.$refs.modal.validate()) {
                axios.post('/back/call-service', this.form, {
                    }).then((response) => {
                    this.close()
                }).catch((error) => {
