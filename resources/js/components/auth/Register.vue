                    ...
                    <v-stepper-items>
                        ...
                        <v-stepper-content step="4">
                            <v-form ref="step4">
                                ...
                                <v-checkbox dense :rules="rules.checkbox" v-model="input.agree" name="agree" hide-details>
                                    <template v-slot:label>
                                        <div class="black--text">Ich habe Gelegenheit gehabt, die Inhalte der</div>
                                    </template>
                                </v-checkbox>
                                ...
                                <v-checkbox dense v-model="input.subscribe" name="subscribe">
                                    <template v-slot:label>
                                        <div class="black--text">Ich möchte zeitnah über die Verfügbarkeit der Arzneimittel im Onlineshop benachrichtigt werden.</div>
                                    </template>
                                </v-checkbox>
