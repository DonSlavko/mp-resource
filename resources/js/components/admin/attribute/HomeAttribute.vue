        ...
        >
            <template v-slot:top>
                <v-toolbar flat color="white">
                    <v-toolbar-title>Eingenschaften</v-toolbar-title>
...
export default {
        ...
        return {
            table: {
                footerProps: {
                    ...
                    itemsPerPageText: 'Eingenschaften pro Seite:',
                    pageText: '{0}-{1} von {2}',
                },
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? "Neue Eigenschaft" : "Eigenschaft bearbeiten";
        },
    },
        ...
        save() {
            if (this.$refs.modal.validate()) {
                if (this.editedIndex > -1) {
                    axios
                        .patch("/back/attributes/" + this.editedItem.id, this.editedItem)
                        .then((response) => {
                            this.initialize();
                            this.close();
                        })
                    ...
                    axios
                        .post("/back/attributes", this.editedItem)
                        .then((response) => {
                            this.initialize();
                            this.close();
