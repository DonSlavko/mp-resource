        ...
        >
            <template v-slot:top>
                <v-toolbar flat color="white">
                    <v-toolbar-title>Eigenschaftswerte</v-toolbar-title>
                    <v-divider class="mx-4" inset vertical></v-divider>
                    <v-spacer></v-spacer>
                    <v-dialog v-model="dialog" max-width="500px">
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on="on"
                            >+ Neuer Eigenschaftswert
                            </v-btn>
                        </template>
                        <v-card>
                            <v-card-title>
...
export default {
        ...
        return {
            table: {
                footerProps: {
                    ...
                    itemsPerPageText: 'Eigenschaftswerte pro Seite:',
                    pageText: '{0}-{1} von {2}',
                },
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? "Neue Eigenschaftswert" : "Eigenschaftswert bearbeiten";
        },
    },
